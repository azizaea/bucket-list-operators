 ...
 */
export async function registerGuide(req: AuthRequest, res: Response): Promise<void> {
  try {
    const {
      email,
      password,
 ...
 */
export async function loginGuide(req: AuthRequest, res: Response): Promise<void> {
  try {
 ...
 */
export async function refreshGuideToken(req: AuthRequest, res: Response): Promise<void> {
  try {
 ...
 */
export async function getGuideProfile(req: AuthRequest, res: Response): Promise<void> {
  try {
 ...
 */
export async function updateGuideProfile(req: AuthRequest, res: Response): Promise<void> {
  try {
    const guideId = req.user?.guideId;
    if (!guideId) {
      res.status(401).json({ success: false, error: 'Not authenticated as guide' });
 ...
 */
export async function uploadLicensePhoto(req: AuthRequest, res: Response): Promise<void> {
  try {
    const guideId = req.user?.guideId;
    if (!guideId) {
      res.status(401).json({ success: false, error: 'Not authenticated as guide' });
 ...
 */
export async function getGuideById(req: AuthRequest, res: Response): Promise<void> {
  try {
 ...
 */
export async function listGuides(req: AuthRequest, res: Response): Promise<void> {
  try {
    const operatorId = req.user?.operatorId;
    if (!operatorId) {
      res.status(401).json({ success: false, error: 'Operator authentication required' });
    ...
    if (maxRate != null) {
      where.hourlyRate = { lte: parseFloat(maxRate as string) };
    }
 ...
 */
export async function getGuideAvailability(req: AuthRequest, res: Response): Promise<void> {
  try {
    const operatorId = req.user?.operatorId;
    const guideId = String(req.params.id || '');
 ...
 */
export async function getGuideItineraries(req: AuthRequest, res: Response): Promise<void> {
  try {
    const guideId = req.user?.guideId;
    if (!guideId) {
      res.status(401).json({ success: false, error: 'Not authenticated as guide' });
 ...
 */
export async function uploadItineraryCoverImage(req: AuthRequest, res: Response): Promise<void> {
  try {
    const guideId = req.user?.guideId;
    const itineraryId = String(req.params.id || '');
